...
question = {
	"Who created JAVA Programming Language": ['James Gosling', 'Dennis Richie', 'Rob pike', 'Guido Van Rossum'],
	" Which one of the following command language is used by UNIX operating system?": ['DCL', 'SHELL', 'MSDOS','C#'],
	"Select India's GDP in trillions": ['3', '5', '9', '7'],
	"Choose the most populated country" : ['India','USA','Brazil','Germany']
}
# define answer list
ans = ['James Gosling', 'SHELL', '5','India']
